...
public:
    ...
    static void createGraph(Graph& g, int startId, const string& outputFile = "graph.dot")
    {
    ...
    static void createShortestPath(Graph& g, int id1, int id2, const string& outputFile = "graph.dot")
    {
        ofstream file(outputFile);
        if (!file) {
            cerr << "Error: Cannot create " << outputFile << endl;
    ...
    static void mutualConnectionGraph(Graph& g, int id1, int id2, const string& outputFile = "graph.dot")
    {
        ofstream file(outputFile);
        if (!file) {
            cerr << "Error: Cannot create " << outputFile << endl;
    ...
    static bool createImage(const string& dotFile = "graph.dot", const string& outputFile = "graph.png")
    {
